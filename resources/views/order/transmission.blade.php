                                ...
                                @foreach ($transmissions as $item)
                                    <tr>
                                        ...
                                        <td><button type="button" id="btnEdit" value="{{ $item->id }}"
                                                ...
                                                data-toggle="modal" data-target="#modal-xl">تغیر</button></td>
                                        <td><button type="button" id="btnDelete" value="{{ $item->id }}"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body mr-5">
                                        <form action="{{ route('save.company') }}" method="POST" id="companySave"
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(index, value) {
                        $('#tbody').append('<tr><td>' + value.tname + '</td><td>' + value
                            ...
                            value.id +
                            '" class="btn btn-primary btn-sm" data-mdb-ripple-color="dark"  data-toggle="modal" data-target="#modal-xl">تغیر راوستل</button></td><td><button type="button" id="btnDelete" value="' +
                            value.id +
