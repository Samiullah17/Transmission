...
<div class="card">
    <div class="card-header">
        <div class="card-tools">
         ...
         <div class="card-tools" style="float: left"><p>د مراجعی نیټه</p>: {{ $order->created_at }}</div>
    </div>
        ...
        <table class="table table-hover table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->pname }}</td>
                    <td>{{ $item->serialNo }}</td>
                    <td>@if($item->rate!=0){{ $item->rate }}@endif @if($item->rate==0) <span class="text-danger">ستونزه لری</span> @endif</td>
                </tr>
